# SME_Academy launch.ps1
# Cross-platform launcher (Windows + macOS via pwsh)
# Rebuilds generated/content_index.json then opens index.html
...
$htmlPath = Join-Path $academyRoot "index.html"
Write-Host "[SME_Academy] Opening index.html..."
